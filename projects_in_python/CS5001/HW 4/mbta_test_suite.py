"""
    ...
    Fall 2019
    HW 4 
    Starter code -- This is a test suite for getting
    directions out of the mbta module.

    This program makes several calls to functions defined
    ...
    individual functions as well):
      * Input: Central to Alewife. Output: 4 stops, towards Alewife
      * Input: Kendall to Savin Hill. Output: 8 stops, towards Ashmont
      * Input: Park St to Broadway. Output: 3 stops, towards Ashmont 
      * Input: Fields Corner to Andrew. Output: 3 stops, towards Alewife
